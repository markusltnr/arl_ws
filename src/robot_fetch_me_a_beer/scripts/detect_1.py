...
class ObjectDetector:
    def __init__(self):
        ...
        self.active = True                             # Is the detector activated or not
    ...
    def base_T_xtion(self, point, time):
        self.listener.waitForTransform(self._xtion_frame, self._base_frame, rospy.Time(), rospy.Duration(5))
        trans, rot = self.listener.lookupTransform(self._xtion_frame, self._base_frame, rospy.Time())
